...
const css = `
  ...
  .tag {
    ...
    border: 1px solid rgba(43,40,34,0.14);
    border-radius: 100px;
    padding: 5px 12px;
    font-family: var(--font);
    font-size: 13px;
    color: rgba(43,40,34,0.88);
    font-weight: 500;
  }
  .tag--niche {
    background: rgba(123,107,227,0.12);
    border-color: rgba(123,107,227,0.28);
    color: rgba(90,78,190,0.95);
  }
